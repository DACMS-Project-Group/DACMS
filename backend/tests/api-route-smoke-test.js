...
async function main() {
  ...
  const lecturerCases = [
    ...
    { label: 'Create listing', method: 'POST', path: '/lecturer/listings/create', body: { moduleId: 1, deadline: '2026-12-31T23:59:59.000Z', minimumGrade: 'C' }, expectedStatus: 200 },
    { label: 'Edit listing', method: 'PATCH', path: '/lecturer/listings/edit/1', body: { moduleId: 1, deadline: '2026-12-31T23:59:59.000Z', minimumGrade: 'C' }, expectedStatus: 200 },
