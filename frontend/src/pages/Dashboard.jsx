...
const Dashboard = () => {
  ...
  const recentActivity = [
    {
      text: 'Application for CMPG xxx',
      time: 'Today 14:22',
    },
    {
      text: 'Uploaded supporting documents',
      time: 'Yesterday 14:22',
    },
    {
      text: 'Added hours worked',
      time: 'Yesterday 14:22',
    },
  ];
            ...
            <Card>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="text-primary font-semibold hover:underline block ml-auto"
                >
                  View all →
                </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              ...
              <Card className="overflow-x-auto">
                ...
                <button
                  onClick={() => navigate('/applications')}
                  className="text-primary font-semibold hover:underline block text-right mt-4 ml-auto"
                >
                  View all →
                </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <Card>
                ...
                <button
                  onClick={() => navigate('/claims')}
                  className="w-full bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-dark transition"
                >
                  Generate New Claim
                </button>
