  ...
  return (
    <div className="min-h-screen bg-off-white">
      ...
      <div className="container mx-auto p-8">
        ...
        {/* ===== QUICK ACTIONS & NOTIFICATIONS SIDE BY SIDE ===== */}
        ...
        <div className="mb-8">
          ...
          <Card className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {/* Loop through overviewData and create a row for each */}
        ...
        {/* ===== APPLICATIONS & CLAIMS SIDE BY SIDE ===== */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  {applications.map((app, index) => (
                    <tr key={index} className="border-b border-neutral last:border-0">
                      ...
                      <td className="py-3 px-4">
                        {/* This is where the StatusBadge component is used */}
