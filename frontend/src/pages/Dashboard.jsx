                ...
                <tbody>
                  {overviewData.map((row, index) => (
                    <tr key={index} className="border-b border-neutral last:border-0">
                      <td className="py-3 px-4 text-dark font-inter">{row.module}</td>
                      <td className="py-3 px-4 text-dark font-inter">{row.hours}</td>
                      <td className="py-3 px-4 text-dark font-inter">{row.earnings}</td>
                      <td className="py-3 px-4 text-dark font-inter">{row.pending}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {applications.map((app, index) => (
                      <tr key={index} className="border-b border-neutral last:border-0">
                        <td className="py-3 px-4 text-dark font-inter">{app.module}</td>
                        <td className="py-3 px-4 text-dark font-inter">{app.date}</td>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {claims.map((claim, index) => (
                      <tr key={index} className="border-b border-neutral last:border-0">
                        <td className="py-3 px-4 text-dark font-inter">{claim.module}</td>
                        <td className="py-3 px-4 text-dark font-inter">{claim.amount}</td>
                        <td className="py-3 px-4">
                          <StatusBadge status={claim.status} />
                        </td>
                        <td className="py-3 px-4 text-dark font-inter">{claim.claimNo}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <Card>
                <div className="space-y-4">
                  {recentActivity.map((activity, index) => (
                    <div
                      key={index}
                      className={index < recentActivity.length - 1 ? 'border-b border-neutral pb-3' : ''}
                    >
                      <p className="font-semibold text-dark font-inter">
                        {activity.text}
                      </p>
