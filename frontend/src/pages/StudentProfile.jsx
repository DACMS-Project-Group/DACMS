...
const StudentProfile = () => {
  ...
  const handleSaveProfile = async (event) => {
    ...
    // Only the 4 fields the backend accepts
    const payload = {
      contactDetails: formData.mobileNo,
              ...
              {isEditing && (
                <div className="flex justify-end pt-4">
                  <button
                    type="submit"
                    disabled={saving}
                    className="bg-primary text-white px-8 py-3 rounded-lg font-bold hover:bg-primary-dark transition shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                  >
