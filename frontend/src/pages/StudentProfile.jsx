...
const StudentProfile = () => {
  ...
  const [notifications] = useState([
    {
      id: 1,
      message: 'Welcome to your NWU Student Profile.',
      timestamp: 'Today',
    },
    {
      id: 2,
      message: 'Ensure all supporting documents are updated before applying.',
      timestamp: 'Yesterday',
    },
  ]);
  ...
  const profileProgress = Math.round(
    (completedFieldsCount / profileFields.length) * 100
  );

  const uploadedDocsCount = requiredDocuments.filter(
    (doc) => documents[doc.key]
  ).length;

  const docProgress = Math.round(
    (uploadedDocsCount / requiredDocuments.length) * 100
  );

  const overallCompletion = Math.round(
    (profileProgress + docProgress) / 2
  );
                  ...
                  <table className="w-full">
                    ...
                    <thead>
                      <tr className="bg-light-grey text-left">
                        <th className="py-3 px-4 text-sm font-semibold text-neutral">
                          Document Title
                        </th>
                        ...
                        <th className="py-3 px-4 text-sm font-semibold text-neutral text-right">
                          Actions
                        </th>
                      </tr>
                    </thead>
                  ...
                  <table className="w-full text-left">
                    ...
                    <thead>
                      <tr className="bg-light-grey">
                        ...
                        <th className="py-2 px-3 text-xs font-semibold text-neutral">
                          Module
                        </th>
                    ...
                    <tbody>
                      ...
                      {applicationHistory.map((app) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-3 text-sm text-dark font-medium">
                            {app.module}
                          </td>

                          <td className="py-3 px-3 text-sm text-dark">
                            {app.date}
                          </td>
